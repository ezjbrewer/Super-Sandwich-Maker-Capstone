# Sandwich Full Stack Group Project
...
1. Run `dotnet user-secrets set SandwichDbConnectionString 'Host=localhost;Port=5432;Username=postgres;Password=password;Database=Sandwich'`
